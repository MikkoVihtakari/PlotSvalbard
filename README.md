...
PlotSvalbard depends on many packages (see **Dependencies**) for dependencies. If you use these packages in your publications, please cite the respective packages.
